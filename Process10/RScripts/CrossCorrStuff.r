...
write.table(binding.characteristics$cross.correlation,paste(file.path(DirectoryOut,"Fragment_Lengths",NewName),".CorrFragfull",sep=""),row.names=FALSE)
NSC <- CorMax/CorMin
...
write.table(ToPrint,paste(file.path(DirectoryOut,"Fragment_Lengths",NewName),".CorrFragLog",sep=""),row.names=FALSE)
