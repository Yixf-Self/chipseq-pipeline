...
source("/lustre/mib-cri/carrol09/Work/MyPipe/Process10/RScripts/HTML_functions6.r")
...
p <- openPage(file.path(WkgDir,"HTML_Report","SampleSummary3.html"))
...
height:500,
width:1000,
chartArea:{left:100,top:0,width:\"50%\",height:\"100%\"},
isStacked:true
}"
...
hwrite("Figure 2 & 3 - Barplot of percentage of total reads within genomic features",br=T,p)
...
hwrite("Figure 11 - The percentage of reads overlapping or not overlapping the MACs peak regions",br=T,p) 
