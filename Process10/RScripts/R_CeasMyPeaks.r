...
IntragenicPeaks <- PeakAnno[PeakAnno[,"Feature"] == "Intragenic",]
...
CountsInSections[1:7,1] <- c("10000upstream_To_5000upstream","5000upstream_To_2000upstream","2000upstream_To_500upstream","500upstream_To_500downstream","500downastream_To_2000downstream","2000downstream_To_Gene_End","Intragenic")
...
#Intragenic<- FurtherCount[FurtherCount[,"Feature"] == "Intragenic","Peak_V4"]

CountsInSections[6,2] <-nrow(FurtherCount[FurtherCount[,"Feature"] == "2000Extended",])
CountsInSections[7,2] <-nrow(FurtherCount[FurtherCount[,"Feature"] == "Intragenic",])
