...
colnames(SSMP) <- c("GenomicsID","SampleName","IGV_Link_Peaks","Fresh_IGV_Link_Peaks","Run","Lane","Tissue","Factor","Antibody","Condition_1","Condition_2","Peaks","Macs_Peaks_Files","Macs_Genes_In_Peaks","Macs_Peaks_In_Genes","Macs_Genes_Annotation","Macs_GO_Terms","Macs_GO_Table")
...
SSMP4 <- SSMP3[,c(1:2,5:11,12,14:15,17,13,16,18,19,21,3:4,23:42)]
ss <- SSMP4
