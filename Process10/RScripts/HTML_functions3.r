...
MakeTable <- paste("var table = new google.visualization.Table(document.getElementById(\"",TableName,"\"));\ntable.draw(sortData2, {allowHtml:true});\n",sep="")
...
Table <- c("SampleName","Tissue","Factor","Antibody","Condition_1","Macs_Peaks","Macs_Genes_In_Peaks","Macs_Peaks_In_Genes","Macs_Genes_Annotation","Macs_GO_Terms","Macs_GO_Table","IGV_Link_Peaks","Fresh_IGV_Link_Peaks")
...
googleStuff <- LinkMyGoogle(SSMP3,Charts,Table,chartOptions,chartTypes,"table2")
googleStuff@jsScript <- ReformatTommyVis(googleStuff@jsScript)
return(googleStuff)
